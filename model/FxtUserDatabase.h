#ifndef FXT_USER_DATABASE_H_
#define FXT_USER_DATABASE_H_
...
class FxtUserDatabase : public Wt::Auth::AbstractUserDatabase
{
public:
  FxtUserDatabase(dbo::Session& session);
...
private:
  ...
  struct WithUser {
    WithUser(const FxtUserDatabase& self, const Wt::Auth::User& user);
    ~WithUser();
